...
function ProjectCard({ project }) {
  return (
    <div className="p-4 -m-4">
      <div className="h-[500px]  w-[300px] md:w-[320px] border-2 border-gray-200 border-opacity-60 rounded-2xl overflow-clip lg:overflow-hidden hover:shadow-md lg:hover:scale-105 transition-all backdrop-blur-3xl shadow-xl flex flex-col">
        <a href="">
          <img
        ...
        <div className="p-4 flex flex-col lg:gap-3 flex-1">
